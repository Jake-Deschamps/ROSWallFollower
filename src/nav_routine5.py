...
def nav_logic(my_scan):
    ...
    # Settings
    k_p_x = 10       # Proportional gain for distance error -> set angle
    k_p_t = .5    # Proportional gain for theta error -> set angular
    ...
    theta_error = theta_set - (rhs - wall_index)*np.pi/180
    w = k_p_t * theta_error
